...
module ccip_write_req import ccip_if_pkg::*; import local_mem_cfg_pkg::*; import VX_gpu_pkg::*; #(
    ...
    output logic            output_cci_pending_writes_full,
    output logic            output_cci_pending_writes_empty,
    output logic           [`CLOG2(CCI_RW_PENDING_SIZE+1)-1:0] output_pending_size

);
    // Handle CCI-P Write Request //////////////////////////////////////////////////////

    wire [`CLOG2(CCI_RW_PENDING_SIZE+1)-1:0] pending_size;
    wire pending_empty;
    wire pending_full;
    ...
    assign output_cci_pending_writes_full  = pending_full;
    assign output_cci_pending_writes_empty = pending_empty;
    assign output_pending_size  = pending_size;
