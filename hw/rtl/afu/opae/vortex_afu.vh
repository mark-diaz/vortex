...
// COMMAND BUFFER:
`define AFU_IMAGE_MMIO_FLUSH 28
`define AFU_IMAGE_MMIO_HOST_RING_BUFFER_BASE_ADDR 30
`define AFU_IMAGE_MMIO_RING_BUFFER_WPTR 32
`define AFU_IMAGE_MMIO_RING_BUFFER_RPTR 34
`define AFU_IMAGE_MMIO_RING_BUFFER_NUM_CMD_REMAINING 36
